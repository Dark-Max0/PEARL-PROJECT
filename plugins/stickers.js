...
if (Config.WORKTYPE == 'private') {
    XTroid.addrex({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    XTroid.addrex({pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    XTroid.addrex({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontaddrexList: true}, (async (message, match) => {    
