...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.addrex({pattern: 'mp3', fromMe: true,  deleteCommand: false, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    Amdi.addrex({pattern: 'photo', fromMe: true,  deleteCommand: false, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
        ...
        ffmpeg(location)
            ...
            .save('Trex.jpg')
            .on('end', async () => {
                await message.client.sendMessage(message.jid, fs.readFileSync('Trex.jpg'), MessageType.image, {quoted: message.data}, {mimetype: Mimetype.jpg , Caption : '❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱ '});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
    ...
    Amdi.addrex({pattern: 'mp3', fromMe: false, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    Amdi.addrex({pattern: 'photo', fromMe: false, desc: Lang.STİCKER_DESC}, (async (message, match) => {    
