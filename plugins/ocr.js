...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.addrex({pattern: 'ocr ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
