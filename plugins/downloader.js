...
Amdi.addrex({pattern: 'play ?(.*)', fromMe: true, desc: Lang.PLAY_DESC}, (async (message, match) => { 
        ...
        if (match[1] === '') return await message.client.sendMessage(message.jid,'ඔබ වචන ඇතුළත් කළ යුතුය',MessageType.text);
    ...
    Amdi.addrex({pattern: 'fsong ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
      ...
      Amdi.addrex({ pattern: 'video ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.VIDEO_DESC}, (async (message, match) => {
        ...
        yt.on('end', async () => {
            ...
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, {mimetype: Mimetype.mp4, caption: "❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱"});
        });
    }));

    Amdi.addrex({ pattern: 'insta ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.IG_DESC}, (async (message, match) => {
    ...
    Amdi.addrex({ pattern: 'fb ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.FBDESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: true}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'spdf ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.SPDF_DESC }, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: true,  deleteCommand: false, desc: Lang.CURRENCY_DESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'tts (.*)', fromMe: true,  deleteCommand: false, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'yt ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'wiki ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'img ?(.*)', fromMe: true, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'quote ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.QUOTE_DESC}, async (message, match) => {
    ...
    Amdi.addrex({pattern: 'wame ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.WAME_DESC}, (async (message, match) => {    
    ...
    Amdi.addrex({ pattern: 'github ?(.*)', fromMe: true,  deleteCommand: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Amdi.addrex({ pattern: 'tk ?(.*)', fromMe: true,  deleteCommand: false, desc: TKlang.TK_DESC }, async (message, match) => {
    ...
    Amdi.addrex({pattern: 'play ?(.*)', fromMe: false, desc: Lang.PLAY_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'song ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({ pattern: 'fsong ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => {
      ...
      Amdi.addrex({ pattern: 'video ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => {
        ...
        yt.on('end', async () => {
            ...
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, {mimetype: Mimetype.mp4, quoted:message.data ,caption: "❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱"});
        });
    }));

    Amdi.addrex({ pattern: 'insta ?(.*)', fromMe: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      Amdi.addrex({ pattern: 'fb ?(.*)', fromMe: false, desc: Lang.FBDESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: false}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'spdf ?(.*)', fromMe: false, desc: Lang.SPDF_DESC }, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'quote ?(.*)', fromMe: false, desc: Lang.QUOTE_DESC}, async (message, match) => {
        if (match[1] === 'xx') return await message.reply(Lang.NEED_LOCATIONA);
        const url = `https://api.quotable.io/random`;
        try {
            const response = await got(url);
    ...
    Amdi.addrex({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: false, desc: Lang.CURRENCY_DESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'tts (.*)', fromMe: false, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'yt ?(.*)', fromMe: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'wiki ?(.*)', fromMe: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'img ?(.*)', fromMe: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Amdi.addrex({pattern: 'wame ?(.*)', fromMe: false, desc: Lang.WAME_DESC}, (async (message, match) => {    
        if (message.reply_message !== false) {
            await message.client.sendMessage(message.jid, Lang.WAME.format(message.reply_message.jid.split('@')[0], message.reply_message.jid.replace('@s.whatsapp.net', ' ')), MessageType.text, {
                quotedMessage: message.reply_message.data, contextInfo: {mentionedJid: [message.reply_message.jid.replace('c.us', 's.whatsapp.net')]}
            });
    ...
    Amdi.addrex({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Amdi.addrex({ pattern: 'tk ?(.*)', fromMe: false, desc: TKlang.TK_DESC }, async (message, match) => {
