...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.addrex({pattern: 'xxx', fromMe: true,  deleteCommand: false,  desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Amdi.addrex({pattern: 'xxx', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
