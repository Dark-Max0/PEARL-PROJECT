...
const YT_NEED = "* ❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱  need word!.*"
const DWLOAD_VID = "* ❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱  SERCHING YOUR SONG PLEASE WAIT....*"
const YTV_UP = "* ❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱  UPLOADING YOUR VIDEO PLEASE WAIT...*"
const NO_RESULT = "*SORRY ❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱ can't Find Anything...*"


if (Config.WORKTYPE == 'private') {

    cobra.addrex({ pattern: 'vid2 ?(.*)', fromMe: true, desc: YTV_DESC,  deleteCommand: false}, async (message, match) => {
