...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.addrex({ pattern: 'spotify ?(.*)', fromMe: true, desc: Lang.SPO_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    Amdi.addrex({ pattern: 'spotify ?(.*)', fromMe: false, desc: Lang.SPO_DESC}, async (message, match) => {
