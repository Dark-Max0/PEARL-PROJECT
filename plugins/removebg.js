...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.addrex({pattern: 'removebg ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
    ...
    Amdi.addrex({pattern: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
