...
if (read.WORKTYPE == 'private') {
  ...
  Amdi.addrex({ pattern: 'tiktok ?(.*)', fromMe: true, dontAddCommandList: true}, async (message, match) => {
  ...
  Amdi.addrex({ pattern: 'tiktok ?(.*)', fromMe: true, dontAddCommandList: true}, async (message, match) => {
   ...
   Amdi.addrex({ pattern: 'tiktok ?(.*)', fromMe: false, dontAddCommandList: true}, async (message, match) => {
