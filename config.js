...
module.exports = {
    ...
    GROUPN1: process.env.GROUP_NAME_1 === undefined ? '❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱ SUPPORT': process.env.GROUP_NAME_1,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/HnRnoj6HBrK32LW0EG3JxE': process.env.GROUP_LINK_1,
